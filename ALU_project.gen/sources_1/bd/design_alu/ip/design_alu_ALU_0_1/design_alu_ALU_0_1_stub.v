...
module design_alu_ALU_0_1(clk, reset, A, B, opcode, RESULT, status_out)
/* synthesis syn_black_box black_box_pad_pin="reset,A[7:0],B[7:0],opcode[1:0],RESULT[15:0],status_out[1:0]" */
