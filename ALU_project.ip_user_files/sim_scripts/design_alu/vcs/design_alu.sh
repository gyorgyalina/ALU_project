...
#
# Script generated by Vivado on Wed Dec 03 15:31:34 +0200 2025
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : design_alu.sh
...
#
# Usage        : design_alu.sh
#                design_alu.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                design_alu.sh [-reset_run]
#                design_alu.sh [-reset_log]
#                design_alu.sh [-help]
#
...
#                script (type 'design_alu.sh -help' for more information).
#
...
# script info
echo -e "design_alu.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./design_alu.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../ALU_project.gen/sources_1/bd/design_alu/ipshared/ec67/hdl" +incdir+"../../../../ALU_project.gen/sources_1/bd/design_alu/ipshared/b28c/hdl" +incdir+"D:/vivado/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../ALU_project.gen/sources_1/bd/design_alu/ipshared/ec67/hdl" +incdir+"../../../../ALU_project.gen/sources_1/bd/design_alu/ipshared/b28c/hdl" +incdir+"D:/vivado/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../../ALU_project.gen/sources_1/bd/design_alu/ipshared/ec67/hdl" +incdir+"../../../../ALU_project.gen/sources_1/bd/design_alu/ipshared/b28c/hdl" +incdir+"D:/vivado/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../ALU_project.gen/sources_1/bd/design_alu/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_vip_v1_1_17 $vlogan_opts -sverilog +incdir+"../../../../ALU_project.gen/sources_1/bd/design_alu/ipshared/ec67/hdl" +incdir+"../../../../ALU_project.gen/sources_1/bd/design_alu/ipshared/b28c/hdl" +incdir+"D:/vivado/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../ALU_project.gen/sources_1/bd/design_alu/ipshared/4d04/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work processing_system7_vip_v1_0_19 $vlogan_opts -sverilog +incdir+"../../../../ALU_project.gen/sources_1/bd/design_alu/ipshared/ec67/hdl" +incdir+"../../../../ALU_project.gen/sources_1/bd/design_alu/ipshared/b28c/hdl" +incdir+"D:/vivado/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../ALU_project.gen/sources_1/bd/design_alu/ipshared/b28c/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../ALU_project.gen/sources_1/bd/design_alu/ipshared/ec67/hdl" +incdir+"../../../../ALU_project.gen/sources_1/bd/design_alu/ipshared/b28c/hdl" +incdir+"D:/vivado/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work generic_baseblocks_v2_1_2 $vlogan_opts +v2k +incdir+"../../../../ALU_project.gen/sources_1/bd/design_alu/ipshared/ec67/hdl" +incdir+"../../../../ALU_project.gen/sources_1/bd/design_alu/ipshared/b28c/hdl" +incdir+"D:/vivado/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../ALU_project.gen/sources_1/bd/design_alu/ipshared/0c28/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_register_slice_v2_1_31 $vlogan_opts +v2k +incdir+"../../../../ALU_project.gen/sources_1/bd/design_alu/ipshared/ec67/hdl" +incdir+"../../../../ALU_project.gen/sources_1/bd/design_alu/ipshared/b28c/hdl" +incdir+"D:/vivado/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../ALU_project.gen/sources_1/bd/design_alu/ipshared/92b2/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work fifo_generator_v13_2_10 $vlogan_opts +v2k +incdir+"../../../../ALU_project.gen/sources_1/bd/design_alu/ipshared/ec67/hdl" +incdir+"../../../../ALU_project.gen/sources_1/bd/design_alu/ipshared/b28c/hdl" +incdir+"D:/vivado/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work axi_data_fifo_v2_1_30 $vlogan_opts +v2k +incdir+"../../../../ALU_project.gen/sources_1/bd/design_alu/ipshared/ec67/hdl" +incdir+"../../../../ALU_project.gen/sources_1/bd/design_alu/ipshared/b28c/hdl" +incdir+"D:/vivado/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../ALU_project.gen/sources_1/bd/design_alu/ipshared/9692/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_crossbar_v2_1_32 $vlogan_opts +v2k +incdir+"../../../../ALU_project.gen/sources_1/bd/design_alu/ipshared/ec67/hdl" +incdir+"../../../../ALU_project.gen/sources_1/bd/design_alu/ipshared/b28c/hdl" +incdir+"D:/vivado/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work axi_protocol_converter_v2_1_31 $vlogan_opts +v2k +incdir+"../../../../ALU_project.gen/sources_1/bd/design_alu/ipshared/ec67/hdl" +incdir+"../../../../ALU_project.gen/sources_1/bd/design_alu/ipshared/b28c/hdl" +incdir+"D:/vivado/Vivado/2024.1/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.design_alu xil_defaultlib.glbl -o design_alu_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./design_alu_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key design_alu_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc design_alu_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./design_alu.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: design_alu.sh [-help]\n\
Usage: design_alu.sh [-step]\n\
Usage: design_alu.sh [-lib_map_path]\n\
Usage: design_alu.sh [-reset_run]\n\
Usage: design_alu.sh [-reset_log]\n\
Usage: design_alu.sh [-keep_index]\n\
Usage: design_alu.sh [-noclean_files]\n\n\
